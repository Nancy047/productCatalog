...
public class IndividualDeleteEvent {
  ...
  public IndividualDeleteEvent atBaseType(String atBaseType) {
  ...
  public IndividualDeleteEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public IndividualDeleteEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public IndividualDeleteEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public IndividualDeleteEvent reportingSystem(EntityRef reportingSystem) {
