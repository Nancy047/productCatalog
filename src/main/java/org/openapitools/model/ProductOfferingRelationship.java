...
public class ProductOfferingRelationship {
  ...
  @Schema(name = "relationshipType", description = "Type of relationship between product offerings such as requires, exchangableTo, optionalFor", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  @Schema(name = "role", description = "The association role for the source product offering", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("role")
