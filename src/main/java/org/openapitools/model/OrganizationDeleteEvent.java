...
public class OrganizationDeleteEvent {
  ...
  public OrganizationDeleteEvent atBaseType(String atBaseType) {
  ...
  public OrganizationDeleteEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public OrganizationDeleteEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public OrganizationDeleteEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public OrganizationDeleteEvent reportingSystem(EntityRef reportingSystem) {
