...
public class OrganizationStateChangeEvent {
  ...
  public OrganizationStateChangeEvent atBaseType(String atBaseType) {
  ...
  public OrganizationStateChangeEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public OrganizationStateChangeEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public OrganizationStateChangeEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public OrganizationStateChangeEvent reportingSystem(EntityRef reportingSystem) {
