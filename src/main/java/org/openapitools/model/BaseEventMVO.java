...
public class BaseEventMVO {
  ...
  public BaseEventMVO atBaseType(String atBaseType) {
  ...
  public BaseEventMVO atSchemaLocation(String atSchemaLocation) {
  ...
  public BaseEventMVO event(Object event) {
    this.event = event;
    return this;
  }
  ...
  public BaseEventMVO eventId(String eventId) {
  ...
  public BaseEventMVO eventTime(OffsetDateTime eventTime) {
  ...
  public BaseEventMVO eventType(String eventType) {
  ...
  public BaseEventMVO correlationId(String correlationId) {
  ...
  public BaseEventMVO domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public BaseEventMVO title(String title) {
    this.title = title;
    return this;
  }
  ...
  public BaseEventMVO description(String description) {
  ...
  public BaseEventMVO priority(String priority) {
  ...
  public BaseEventMVO timeOcurred(OffsetDateTime timeOcurred) {
