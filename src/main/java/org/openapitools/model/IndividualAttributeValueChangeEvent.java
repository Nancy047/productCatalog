...
public class IndividualAttributeValueChangeEvent {
  ...
  public IndividualAttributeValueChangeEvent atBaseType(String atBaseType) {
  ...
  public IndividualAttributeValueChangeEvent atSchemaLocation(String atSchemaLocation) {
  ...
  public IndividualAttributeValueChangeEvent href(String href) {
    this.href = href;
    return this;
  }
  ...
  public IndividualAttributeValueChangeEvent id(String id) {
    this.id = id;
    return this;
  }
  ...
  public IndividualAttributeValueChangeEvent timeOccurred(OffsetDateTime timeOccurred) {
  ...
  public IndividualAttributeValueChangeEvent source(EntityRef source) {
    this.source = source;
    return this;
  }
  ...
  public IndividualAttributeValueChangeEvent reportingSystem(EntityRef reportingSystem) {
